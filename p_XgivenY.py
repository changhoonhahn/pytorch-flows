...
for epoch in range(epochs):
    ...
    torch.save({'epoch': epoch,
        ...
        '/tigress/chhahn/arcoiris/p_XgivenY_model_checkpoint.pt')
    # save model only
    torch.save(model.state_dict(), '/tigress/chhahn/arcoiris/p_XgivenY_model_state.pt')
